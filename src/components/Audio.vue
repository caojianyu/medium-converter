...
import { dataList, globalData, indexData, selectFile, clearList, openParamsPanel, delByIndex, start, selectSuffix, selectChild } from "../common/script/audio/audio";
import { store } from '../store';
import { audioParamList } from '../common/constants';
</script>
...
<template>
  ...
  <Params v-model="store.showModel" :param-list="audioParamList" :index-data="indexData" @close="store.showModel = false"
