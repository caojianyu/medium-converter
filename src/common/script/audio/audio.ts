...
import { audioFormatArr, audioParamList, videoFormatArr } from "../../constants";
...
/** 选择文件的扩展名称 */
const extensions = audioFormatArr.concat(videoFormatArr);
...
/** 文件选择 */
function selectFile() {
    useSelectFile(extensions, audioParamList, dataList)
}
...
function selectChild(index: number) {
    useSelectChild(index, audioParamList, indexData, dataList, globalData)
}
